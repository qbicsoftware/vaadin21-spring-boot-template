...
import life.qbic.data.views.map.MapView;
import life.qbic.data.views.helloworld.HelloWorldView;
import life.qbic.data.views.login.LoginView;
import com.vaadin.flow.component.avatar.Avatar;
import life.qbic.data.data.entity.User;
import life.qbic.data.security.AuthenticatedUser;
...
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent() {
        H2 appName = new H2("QBiC Data Manager");
